...
{
    cout << setw(10) << "first name" << setw(10) << "last name" << setw(12) << "national code" << setw(10) << "fathers name" << setw(10) << "birrth day" << endl;
    cout << setw(10) << first_name << setw(10) << last_name << setw(12) << national_code << setw(10) << fathers_name << setw(10) << birrth_day << endl;
}