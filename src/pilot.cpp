...
pilot::pilot(int deg , string p_code , std::string r_day , string f_name , string l_name , string n_code , string birth_d) : air_hostes(p_code , r_day , f_name , l_name , n_code , birth_d)
{
    while (1)
    {
        try
...
{
    cout << setw(10) << "first name" << "\t" << setw(10) << "last name" << "\t" << setw(10) << "perssonel code" << "\t" << setw(10) << "recruitment day"  << "\t" << setw(6) << "degree" << endl;
